...
class QuestionViewController: UIViewController {
    ...
    func initScene() {
        questionText.text = questions[currentQuestion - 1]["text"] as! String
        for i in 0...3 {
           answers[i].setTitle(questions[currentQuestion - 1]["answers"]?[i] as! String, for: .normal)
        }
    ...
    func nextScreen() {
        if selected != "" {
            ...
            vc.score = score
            vc.answer = selected
            vc.correctAnswer = questions[currentQuestion - 1]["answers"]?[Int(questions[currentQuestion - 1]["answer"] as! String)! - 1] as! String
